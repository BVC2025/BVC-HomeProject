...
export const ROUTE_PERMISSIONS = {
  ...
  "/customer-task-timeline": "customer.task_timeline.view",
  "/production-schedule/:id": "production_schedule.view",
  "/purchase-order-approval/:id": "purchase_order.view",
