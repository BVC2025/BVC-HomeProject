...
@router.post("/sales-orders", dependencies=[Depends(require("sales_order.manage"))])
def create_so(
...
@router.get("/sales-orders/_settings", dependencies=[Depends(require("sales_order.view"))])
...
@router.patch("/sales-orders/_settings", dependencies=[Depends(require("sales_order.manage"))])
...
@router.get("/sales-orders/{so_id}", dependencies=[Depends(require("sales_order.view"))])
def get_so(
    so_id: int,
    db: Session = Depends(get_db)
):
...
@router.patch("/sales-orders/{so_id}", dependencies=[Depends(require("sales_order.manage"))])
def update_so(
    so_id: int,
...
@router.delete("/sales-orders/{so_id}", dependencies=[Depends(require("sales_order.manage"))])
def delete_so(
    so_id: int,
    force: bool = False,
    db: Session = Depends(get_db)
...
@router.post("/sales-orders/{so_id}/lines", dependencies=[Depends(require("sales_order.manage"))])
def add_line(
    so_id: int,
    data: SOLineCreate,
    db: Session = Depends(get_db)
...
@router.patch("/sales-orders/{so_id}/lines/{line_id}", dependencies=[Depends(require("sales_order.manage"))])
def update_line(
    so_id: int,
    line_id: int,
    data: SOLineUpdate,
...
@router.delete("/sales-orders/{so_id}/lines/{line_id}", dependencies=[Depends(require("sales_order.manage"))])
def delete_line(
    so_id: int,
    line_id: int,
    db: Session = Depends(get_db)
...
@router.post("/sales-orders/{so_id}/confirm", dependencies=[Depends(require("sales_order.manage"))])
def confirm_so(
    so_id: int,
    db: Session = Depends(get_db)
):
...
@router.post("/sales-orders/{so_id}/start-production", dependencies=[Depends(require("sales_order.manage"))])
...
@router.post("/sales-orders/{so_id}/ship", dependencies=[Depends(require("sales_order.manage"))])
def ship_so(
    so_id: int,
    db: Session = Depends(get_db)
):
...
@router.post("/sales-orders/{so_id}/deliver", dependencies=[Depends(require("sales_order.manage"))])
def deliver_so(
    so_id: int,
    db: Session = Depends(get_db)
):
...
@router.post("/sales-orders/{so_id}/close", dependencies=[Depends(require("sales_order.manage"))])
def close_so(
    so_id: int,
    db: Session = Depends(get_db)
):
...
@router.post("/sales-orders/{so_id}/cancel", dependencies=[Depends(require("sales_order.manage"))])
def cancel_so(
    so_id: int,
    data: SOCancellation,
    db: Session = Depends(get_db)
...
@router.post("/sales-orders/{so_id}/payment", dependencies=[Depends(require("sales_order.manage"))])
def record_payment(
    so_id: int,
...
@router.post("/sales-orders/from-quotation", dependencies=[Depends(require("sales_order.manage"))])
...
@router.get("/sales-orders/{so_id}/activity", dependencies=[Depends(require("sales_order.view"))])
def get_activity(
    so_id: int,
    db: Session = Depends(get_db)
):
...
@router.delete("/sales-orders/{so_id}/activity/{activity_id}", dependencies=[Depends(require("sales_order.manage"))])
