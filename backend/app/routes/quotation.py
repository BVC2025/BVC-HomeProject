...
# RBAC sweep: the 4 /q/{token}... public customer-facing endpoints below
# (view/respond/negotiate) are deliberately left ungated — no ERP login
# exists on that side of the flow.
_QUOTATION_VIEW_DEP = Depends(require("quotation.view"))
_QUOTATION_MANAGE_DEP = Depends(require("quotation.manage"))
...
@router.get("/quotations/_settings", dependencies=[_QUOTATION_VIEW_DEP])
...
@router.patch("/quotations/_settings", dependencies=[_QUOTATION_MANAGE_DEP])
...
@router.post("/quotations", dependencies=[_QUOTATION_MANAGE_DEP])
...
@router.get("/quotations", dependencies=[_QUOTATION_VIEW_DEP])
def list_quotations(
...
@router.get("/quotations/{quotation_id}", dependencies=[_QUOTATION_VIEW_DEP])
def get_quotation(
    quotation_id: int,
    db: Session = Depends(get_db)
):
...
@router.patch("/quotations/{quotation_id}", dependencies=[_QUOTATION_MANAGE_DEP])
...
@router.delete("/quotations/{quotation_id}", dependencies=[_QUOTATION_MANAGE_DEP])
...
@router.post("/quotations/{quotation_id}/lines", dependencies=[_QUOTATION_MANAGE_DEP])
def add_line(
    quotation_id: int,
...
@router.patch("/quotations/{quotation_id}/lines/{line_id}", dependencies=[_QUOTATION_MANAGE_DEP])
def update_line(
    quotation_id: int,
    line_id: int,
...
@router.delete("/quotations/{quotation_id}/lines/{line_id}", dependencies=[_QUOTATION_MANAGE_DEP])
def delete_line(
    quotation_id: int,
    line_id: int,
    db: Session = Depends(get_db)
...
@router.post("/quotations/{quotation_id}/send", dependencies=[_QUOTATION_MANAGE_DEP])
def send_quotation(
    quotation_id: int,
    db: Session = Depends(get_db)
):
...
@router.post("/quotations/{quotation_id}/resend-email", dependencies=[_QUOTATION_MANAGE_DEP])
def resend_email(
    quotation_id: int,
    db: Session = Depends(get_db)
):
...
@router.post("/quotations/{quotation_id}/approve", dependencies=[_QUOTATION_MANAGE_DEP])
...
@router.post("/quotations/{quotation_id}/reject", dependencies=[_QUOTATION_MANAGE_DEP])
...
@router.get("/quotations-auto-price", dependencies=[_QUOTATION_VIEW_DEP])
def auto_price(
...
@router.post("/quotations/from-requirements", dependencies=[_QUOTATION_MANAGE_DEP])
...
@router.get("/quotations/{quotation_id}/activity", dependencies=[_QUOTATION_VIEW_DEP])
def get_activity(
    quotation_id: int,
    db: Session = Depends(get_db)
):
...
@router.delete("/quotations/{quotation_id}/activity/{activity_id}", dependencies=[_QUOTATION_MANAGE_DEP])
...
@router.post("/quotations/auto-generate", dependencies=[_QUOTATION_MANAGE_DEP])
...
@router.get("/quotations-dashboard-stats", dependencies=[_QUOTATION_VIEW_DEP])
@router.get("/quotations/dashboard-stats", dependencies=[_QUOTATION_VIEW_DEP])
...
@router.get("/quotations-pricing-breakdown", dependencies=[_QUOTATION_VIEW_DEP])
@router.get("/quotations/pricing-breakdown", dependencies=[_QUOTATION_VIEW_DEP])
